const projectsData = [
    {
        ...
        image: require("../images/webp/LessonManager.webp"),
        fallback: require("../images/fallback/LessonManager.png"),
        tools: ["React", "PHP", "PostgreSQL"],
    ...
    },
    {
        ...
        image: require("../images/webp/Timebox.webp"),
        fallback: require("../images/fallback/Timebox.png"),
