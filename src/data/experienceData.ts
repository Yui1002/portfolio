const experienceData = [
    {
        companyName: "SaferMobility",
        position: "Software Engineer | Intern",
        period: 'Mar 2025 - Present',
        description: [
            "Redesigning a web and mobile application for university students to make emergency calls",
    ...
    },
    {
        ...
        description: [
            "Team leader and architect of the full-stack application (web/mobile/server)",
            "Working with Amazon RDS and designing a database schema to achieve high scalability",
